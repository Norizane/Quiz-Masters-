        ...
        <Row>
          <Col className="d-flex justify-content-center">
            ...
            >
              ...
              <Card.Footer style={{ backgroundColor: "#A393BF" }}className="rounded-bottom d-flex justify-content-center">
                <Button
                  size="lg" 
                  onClick={() => navigate("/MillionairesCreate")}
          ...
          <Col className="d-flex justify-content-center">
            ...
            >
              ...
              <Card.Footer style={{ backgroundColor: "#A393BF" }}className=" rounded-bottom d-flex justify-content-center">
                <Button
                  size="lg"
                  onClick={() => navigate("/MillionairesPlay")}
                  variant="outline-light"
                >
                  Play
                </Button>
